...
! function(a) {
    ...
    a.widget("selectBox.selectBoxIt", {
        ...
        _replaceSelectBox: function() {
            ...
            })), f.selectBox.after(f.dropdownContainer), f.dropdownContainer.removeClass("selectboxit-rendering"), f.dropdownText.css({
        ...
        _addClasses: function(a) {
            ...
            return b.selectedClass = "selectboxit-selected", b.downArrow.addClass(b.selectBox.attr("data-downarrow") || b.options.downArrowIcon || e), b.dropdownContainer.addClass(f), b.dropdown.addClass(c), b.list.addClass(d), b
        },
    ...
    e.add = function(b, c) {
        ...
        var b = this;
        return b.options.disabled || (b.close(), b.selectBox.attr("disabled", "disabled"), b.dropdown.removeAttr("tabindex").removeClass(b.theme.enabled).addClass(b.theme.disabled), b._setOption("disabled", !0), b.triggerEvent("disable")), b._callbackSupport(a), b
        ...
        if ("number" === a.type(b.listSize)) b.list.css("max-height", b.maxHeight || "none");
            ...
            var e = b.dropdown.offset().top,
                ...
                k = i + j >= e + g + f,
                l = !k;
            if (b.list.data("max-height") || b.list.data("max-height", b.list.outerHeight()), l)
                if (b.dropdown.offset().top - j >= f) b.list.css("max-height", f), b.list.css("top", b.dropdown.position().top - b.list.outerHeight()), b.dropdown.addClass(c);
                else {
                    var m = Math.abs(e + g + f - (i + j)),
                        n = Math.abs(b.dropdown.offset().top - j - f);
                    n > m ? (b.list.css("max-height", f - m - g / 2), b.list.css("top", "auto"), b.dropdown.addClass(d)) : (b.list.css("max-height", f - n - g / 2), b.list.css("top", b.dropdown.position().top - b.list.outerHeight()), b.dropdown.addClass(c))
                } else b.list.css("max-height", f), b.list.css("top", "auto"), b.dropdown.addClass(d)
        }
        return b
    }, e.enable = function(a) {
        var b = this;
        return b.options.disabled && (b.triggerEvent("enable"), b.selectBox.removeAttr("disabled"), b.dropdown.attr("tabindex", 0).removeClass(b.theme.disabled).addClass(b.theme.enabled), b._setOption("disabled", !1), b._callbackSupport(a)), b
        ...
        var d, e, f, g, h = this,
            ...
            k = h.textArray,
            l = h.currentText,
            m = "number" === a.type(i.numSearchCharacters) ? i.numSearchCharacters : 3;
        for (d = b, f = k.length; f > d; d += 1) {
            for (g = k[d], e = 0; f > e; e += 1) - 1 !== k[e].search(c) && (j = !0, e = f);
            if (j || (h.currentText = h.currentText.charAt(h.currentText.length - 1).replace(/[|()\[{.+*?$\\]/g, "\\$0"), l = h.currentText), c = new RegExp(l, "gi"), l.length < m) {
            ...
            } else if (-1 !== g.search(c)) return h._setCurrentSearchOption(d), !1;
            if (g.toLowerCase() === h.currentText.toLowerCase()) return h._setCurrentSearchOption(d), h.currentText = "", !1
        }
        return !0
