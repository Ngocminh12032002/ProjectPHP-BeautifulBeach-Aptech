        ...
        <div class="slider">
            <div class="slides">
                ...
                <div class="slide first">
                    <a href="<?php echo _WEB_ROOT; ?>/service/hotel-coto">
                        <div class="slide-img">
        ...
        <div class="menu-container">
            ...
            <div class="food-items">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs1.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Vinpearl Resort Nha Trang</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel1.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Virgo Hotel Nha Trang</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homstay1.jpg.crdownload"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">InterContinental Nha Trang
                        </h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Apus Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homestay2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Happy Homestay</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Vinpearl Luxury Nha Trang</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$15.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homestay3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Sandy Beach</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$35.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Amiana Resort Nha Trang</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Truong Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homestay4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Yoko Onsen</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Vinpearl Resort & Spa Nha Trang Bay</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$5.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Panorama central Nha Trang</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homestay5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/rs6.jpg "
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/hotel6.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/nhatrang/homestay6.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
