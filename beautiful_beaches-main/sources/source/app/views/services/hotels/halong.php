        ...
        <div class="menu-container">
            ...
            <div class="food-items">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs1.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Vinpearl Resort & Spa Ha Long</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel1.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Tuan Chau Havana Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homstay1.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Green Pearl Villa Ha Long</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Green Suites Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homestay2.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Tuan Chau Homestay</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Tuan Chau Resort Ha Long</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$15.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Paradise Suites Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homestay3.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Whisper Nature Bungalow</h2>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Khách sạn Time Lotus Hạ Long</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homestay4.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Mon Cheri Cruises</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$5.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Luxury Palace Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homestay5.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                ...
                <div class="food-item featured">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/rs6.jpg "
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Indochine Cruise</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/hotel6.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
                        <h2 class="food-name">Ngọc Lan Hạ Long Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    <div class="food-img">
                        <img src="<?php echo _WEB_ROOT; ?>/publics/assets/photos/service/hotel/halong/homestay6.jpg"
                            alt="food image">
                    </div>
                    <div class="food-content">
