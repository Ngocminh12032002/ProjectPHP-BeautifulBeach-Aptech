        ...
        <div class="slider">
            <div class="slides">
                ...
                <div class="slide first">
                    <a href="<?php echo _WEB_ROOT; ?>/service/hote-coto">
            ...
            <div class="food-items">
                ...
                <div class="food-item featured">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Vung Tau Melody Apartment</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">AVS Hotel Vũng Tàu</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Diamond Sea
                        </h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Mövenpick Villas</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Resort & Spa</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$15.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item today-special">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Luxury Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item new-arrival">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Seashells Hotel & Spa</h2>
                        <div class="line"></div>
                        <h3 class="food-price">$35.00</h3>
                        <ul class="rating">
                            <li><i class="fas fa-star"></i></li>
                ...
                <div class="food-item featured">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Novotel Resort</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Apart Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Paralia Beach Hotel</h2>
                        <div class="line"></div>
                ...
                <div class="food-item featured">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">MerPerle Resort</h2>
                        <div class="line"></div>
                ...
                <div class="food-item today-special">
                    ...
                    <div class="food-content">
                        <h2 class="food-name">Sun Hotel</h2>
                        <div class="line"></div>
