...
<div class="card p-10 pt-15 b-t-1-869fb229">
    ...
    <div class="card-body px-20 mt-2 row" style="min-height: 610px;">
        <form class="col-md-10" method="post" action="<?php echo _WEB_ROOT; ?>/admin/users/editPost ?>">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    ...
                    <input hidden name="id" type="number" class="form-control" id=""
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input name="address" type="text" class="form-control" id=""
                        value="<?php echo $dataList[0]['address'] ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-3 col-form-label">Avata</label>
                <div class="col-sm-7">
                    <input name="avata" type="text" class="form-control" id=""
                        value="<?php echo $dataList[0]['avata'] ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-3 col-form-label">About Content</label>
                <div class="col-sm-7">
                    <input name="about_content" type="text" class="form-control" id=""
                        value="<?php echo $dataList[0]['about_content'] ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-3 col-form-label">Contact FaceBook</label>
                <div class="col-sm-7">
                    <input name="contact_facebook" type="text" class="form-control" id=""
                        value="<?php echo $dataList[0]['contact_facebook'] ?>">
                </div>
            </div>
            <div class="form-group row">
